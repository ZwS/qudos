...
/*
 * Public Domain C source implementation of RFC 1320: The MD4 Message-Digest
 * Algorithm http://www.faqs.org/rfcs/rfc1320.html
 */
...
#else
static void
PerformMD4(const unsigned char *buf, int length, uint32_t * digest)
#endif
{
