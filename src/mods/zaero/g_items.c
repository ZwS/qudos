...
void SpawnItem (edict_t *ent, gitem_t *item)
{
	...
	{	
		...
		if (strcmp(ent->classname, "weapon_flaregun") == 0)
		{
 			ent->s.effects |= EF_COLOR_SHELL;
 			ent->s.renderfx |= RF_SHELL_RED;
 		}
 		if (strcmp(ent->classname, "weapon_sniperrifle") == 0)
		{
 			ent->s.effects |= EF_COLOR_SHELL;
 			ent->s.renderfx |= RF_SHELL_GREEN;
 		}
 		if (strcmp(ent->classname, "weapon_lasertripbomb") == 0)
		{
 			ent->s.effects |= EF_COLOR_SHELL;
 			ent->s.renderfx |= RF_SHELL_RED;
 		}
 		if (strcmp(ent->classname, "weapon_soniccannon") == 0)
		{
 			ent->s.effects |= EF_COLOR_SHELL;
 			ent->s.renderfx |= RF_SHELL_BLUE;
 		}
 		if (strcmp(ent->classname, "weapon_empnuke") == 0)
		{
 			ent->s.effects |= EF_COLOR_SHELL;
 			ent->s.renderfx |= RF_SHELL_GREEN;
 		}
 		if (strcmp(ent->classname, "weapon_a2k") == 0)
		{
 			ent->s.effects |= EF_COLOR_SHELL;
 			ent->s.renderfx |= RF_SHELL_GREEN;
 		}
